...
public class Component {
    ...
    public <T extends Component>List<T> findComponents(Class<T> componentClass,WebDriver driver){
        ...
        //Define component clsass constructor params
        ...
        try {
            ...
            throw new IllegalArgumentException("[ERR] thw component mush have a constructor with params" + Arrays.toString(params));
        }
